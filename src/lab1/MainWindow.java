...
public class MainWindow extends javax.swing.JFrame implements AddingUser, AddingMessage{
    ...
    public void refreshList()
    {
        ...
        jScrollPane2.setSize(widthSize*11, jScrollPane1.getSize().height);  
    }
    ...
    private void sendButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendButtonActionPerformed
        ...
        if(messageText.getText().contains("/temp") && messageText.getText().length() > 6 )
        {
        ...
        else if(messageText.getText().contains("/temp")) {
            this.messageListan.addMessage("Incorrect use of /temp, write like this /temp Sundsvall ");
            refreshMsgList();
        }
        else{
